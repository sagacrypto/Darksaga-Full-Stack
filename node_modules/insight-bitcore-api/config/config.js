...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\DarkSaga\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/DarkSaga/';
  if (isLinux) dataDir = process.env.HOME + '/.darksaga/';
}
dataDir = '/root/.darksaga';
